...
const WebApp = () => {
  return (
    <ThemeProvider theme={theme}>
      <>
        <Head>
          <title>VITS |Innovative Solutions for a Connected World.</title>
          ...
          <meta
            name="keywords"
            content="IT Solutions, Networking Infrastructure, Security, Security Systems"
          />
        </Head>
        {/* end of head */}
        ...
        <AppWrapper>
          ...
          <ContentWrapper>
            ...
            <Video />
            <Services />
            <Clients clientData={false} />
            <Clients clientData={true} />
